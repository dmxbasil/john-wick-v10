...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇs', url='https://t.me/OTT_Updated')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇs', url='https://t.me/zb_movies_official')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "📢𝖱𝖾𝗊𝗎𝖾𝗌𝗍 𝗍𝗈 J𝗈𝗂𝗇 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 📢", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**𝐇𝐞𝐲..𝐁𝐫𝐮𝐡 🙋‍♂️ \n താഴെ കാണുന്ന 📢𝖱𝖾𝗊𝗎𝖾𝗌𝗍 𝗍𝗈 J𝗈𝗂𝗇 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 📢 എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയിത് ചാനലിൽ ജോയിൻ ആയതിന് ശേഷം, \n താഴെ കാണുന്ന 🔄 𝖳𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 🔄 എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക സിനിമ ലഭിക്കുന്നതാണ്...!!**",
